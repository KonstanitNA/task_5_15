...
public class BinaryTree<T> implements DefaultBinaryTree<T> {
    ...
    public void addNode(BinaryTree<Integer>.SimpleTreeNode leave, boolean left, int value) {
        BinaryTree<Integer>.SimpleTreeNode newNode = new BinaryTree<Integer>.SimpleTreeNode(value);
        if (left) {
            leave.setLeft(newNode);
        } else {
            leave.setRight(newNode);
        }
    }
